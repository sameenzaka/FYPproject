...
<!--//nav-item-->
	...
	<!-- <div class="container" style="max-width: 1000px ; width: 100% ; padding: 25px 30px ; border-radius: 25px ; background: linear-gradient(135deg, #dcdcdc, #f8b425);"> -->
		<div class="heading" style="font-size: 25 ; font-weight: 500 ; position: relative ; text-align: center ; padding: 0 0 20px 0;">Buyers Records</div>
...
<table class="table">
	...
	<thead>
		<tr>
			...
			<th style="text-align: center ;">Buyer Address</th>
...
$sql = "DELETE FROM buyer WHERE buyer_cnic=".$_REQUEST["buyer_cnic"];
...
<tbody>
	<tr>
		...
		<td style="text-align: center ;"><a href = "mailto: <?php echo $row["buyer_email"];?>"><?php echo $row["buyer_email"];?></a></td>
		<td style="text-align: center ;"><?php echo $row["buyer_address"]?></td>
		<td style="text-align: center ;"><?php echo $row["buyer_cnic"]?></td>
		<td>
			<a class="btn btn-danger btn-sm" href="List-buyer.php?buyer_cnic=<?php echo $row["buyer_cnic"];?>&action=delete">Delete</a>
