...
$agentarea = $_POST["agent_area"];
$agentpass = $_POST["agent_password"];
$agentcnic=$_POST["agent_cnic"];
if($action == "update"){

$sql = "UPDATE agent set agent_name='".$agentname."' ,agent_email='".$agentemail."' ,agent_id='".$agentid."',agent_password='".$agentpass."',agent_mobile='".$agentmobile."',agent_area='".$agentarea."',agent_cnic='".$agentcnic."' WHERE id=".$_SESSION["agent-login"];
		...
		<form action="" method="post" enctype="multipart/form-data" >
			<div class="card-details">
				...
				<div class="card-box">
					...
					<input name="agent_name" type="text" value="<?php echo $row["agent_name"]; ?>" />
				</div>


				<div class="card-box">
					<span class="details">Email</span>
					<input type="email" name="agent_email" id="agent_email" value="<?php echo $row["agent_email"]; ?>" />
				</div>


				<div class="card-box">
					<span class="details">Agent ID.</span>
					<input type="numbers" name="id" id="agent_id" value="<?php  echo $row["agent_id"]; ?>">
				</div>


				<div class="card-box">
					<span class="details">Mobile Number</span>
					<input type="numbers" name="agent_mobile" id="agent_mobile" value="<?php echo $row["agent_mobile"]; ?>" />
				</div>
				<div class="card-box">
					<span class="details">Area</span>
				<div class="subject mb-3">
                                                <select id="agent_area" name="agent_area" class="form-control" >
												<option value="<?php echo $row["agent_area"]; ?>"><?php echo $row["agent_area"]; ?></option>
												<?php
				...
				<div class="card-box">
					...
					<input type="text" name="agent_cnic" id="agent_area" value="<?php echo $row["agent_cnic"]; ?>" />
				</div>
				
				<div class="card-box">
					<span class="details">Password</span>
					<input type="password" name="agent_password" id="agent_pass" value="<?php  echo $row["agent_password"]; ?>">
				</div>
