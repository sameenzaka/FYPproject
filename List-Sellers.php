...
<head>
	<title>Abdullah States | Sellers</title>
...
<body class="app">
	...
	<!-- <div class="container" style="max-width: 1200px ; width: 100% ; padding: 25px 30px ; border-radius: 25px ; background: linear-gradient(135deg, #dcdcdc, #f8b425);"> -->
		<div class="heading" style="font-size: 25 ; font-weight: 500 ; position: relative ; text-align: center ; padding: 0 0 20px 0;">Sellers Records</div>
...
<table class="table">
	...
	<thead>
		<tr>
			...
			<th style="text-align: center ;">Seller Phone</th>
			<th style="text-align: center ;">Seller Address</th>
			<th style="text-align: center ;">Seller CNIC</th>	
...
$sql = "DELETE FROM seller WHERE seller_cnic=".$_REQUEST["seller_cnic"];
...
<tbody>
	<tr>
		<td style="text-align: center ;"><?php echo $row["seller_name"]?></td>
		<td style="text-align: center ;"><a href = "mailto: <?php echo $row["seller_email"];?>"><?php echo $row["seller_email"];?></a></td>
		<td style="text-align: center ;"><?php echo $row["seller_phone"]?></td>
		<td style="text-align: center ;"><?php echo $row["seller_address"]?></td>
		<td style="text-align: center ;"><?php echo $row["seller_cnic"]?></td>
		<td>
			<a class="btn btn-danger btn-sm" href="List-Sellers.php?seller_cnic=<?php echo $row["seller_cnic"];?>&action=delete">Delete</a>
