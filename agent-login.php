...
$sql = mysqli_query($conn , "select * from agent where agent_name = '$name' and agent_password = '$password'");
$row = (mysqli_fetch_array($sql));
if(isset($row['agent_name']) == $name && (isset($row["agent_password"]) == $password) ){
echo "Login successful <br> Welcome " . $row["agent_name"];

$_SESSION["agent-login"] = $row["id"];
if(isset($_SESSION["agent-login"])){
header('location:seller-record.php');
}
}
else{
?>
                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            <form action="" method="POST" class="" enctype="multipart/form-data">
                                <h2 class="fw-bold mb-2 text-uppercase">Agent Login</h2>
                                <p class="text-white-50 mb-5">Please enter your login and password!</p>
                                
                                <div class="form-outline form-white mb-4">
                                    <input name="agent_name" type="text" class="form-control form-control-lg"  placeholder="Name" required> 
                                    <label class="form-label" for="typeEmailX">Name</label>
                                </div>
                                
                                <div class="form-outline form-white mb-4">
                                    <input name="agent_password" type="password" class="form-control form-control-lg" placeholder="Password" required>
