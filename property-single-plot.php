...
$news=$_GET['id'];
$plotid=$_GET['id'];
$sql = "SELECT * from addplot WHERE plot_id = '$news' ";
...
?>			
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="properties-img" style="background-image: url(../seller/plot-images/<?php echo $row["image1"];?>);" ></div>
          				</div>
          				<div class="item">
          					<div class="properties-img" style="background-image: url(../seller/plot-images/<?php echo $row["image2"];?>);" ></div>
          				</div>
          				<div class="item">
          					<div class="properties-img" style="background-image: url(../seller/plot-images/<?php echo $row["image3"];?>);" ></div>
          				</div>
          			</div>
          		</div>
  ...
  <source src="../seller/plot-videos/<?php echo $row["video"];?>" type="video/mp4">
  <source src="../seller/plot-videos/<?php echo $row["video"];?>" type="video/ogg">
...
<?php }}?>				
          		<div class="col-md-12 properties-single ftco-animate mb-5 mt-5">
          			...
          			<div class="row">
<?php
$sql = "SELECT * from addplot ORDER BY plot_id ASC LIMIT 2";
$result=mysqli_query($conn,$sql);
if(mysqli_num_rows($result)){
while($row=mysqli_fetch_assoc($result)){
?>	
          				<div class="col-md-6 ftco-animate">
				    				<div class="properties">
				    					<a href="property-single-plot.php?id=<?php echo $row['plot_id']; ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(../seller/plot-images/<?php echo $row["image1"];?>);" >
...
if(isset($_SESSION["buyer-login"])){
    ...
    $sql = "INSERT INTO buyerrequest (buyer_id,buyer_name , buyer_cnic,plot_id,buyer_email) VALUES('$buyerid','$buyername' ,'$buyercnic','$plotid','$buyeremail' )";
