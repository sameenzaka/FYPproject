...
$sql = mysqli_query($conn , "select * from admin where username = '$name' and password = '$password'");
$row = (mysqli_fetch_array($sql));
if(isset($row['username']) == $name && (isset($row["password"]) == $password) ){
              ...
              <div class="card text-white" style="border-radius: 1rem;background-color:rgba(0, 0, 0, 0.6);">
                <div class="card-body p-5 text-center">
                    ...
                    <div class="mb-md-5 mt-md-4 pb-5">
                        ...
                        <input name="username" type="text" class="form-control form-control-lg" placeholder="Email" required> 
