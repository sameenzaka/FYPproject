					...
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						<li class="nav-item">
							...
							<a class="nav-link" href="seller-record.php">
								...
								<span class="nav-link-text">Seller Records</span>
							</a>
							<!--//nav-link-->
						</li>
						<li class="nav-item">
						...
						<li class="nav-item active">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link active" href="expert-guide.php">
								<span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-columns-gap"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd"
									...
									<table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Link Of House</th>
										...
										$sql = "SELECT * FROM expertguide where agent_area=(SELECT agent_area FROM agent where id ='{$agent_id}')";										
										$result = mysqli_query($conn,$sql);
										if(mysqli_num_rows($result)>0){
										while($row=mysqli_fetch_assoc($result)){
										?>
										<tbody>
											<tr>
												...
												<td class="cell"><a href = "mailto: <?php echo $row["email"];?>"><?php echo $row["email"];?></a></td>
												<td class="cell"><?php echo $row["subject"];?></td>
												<td class="cell"><a href="<?php echo $row["link"];?>" target=_blank><?php echo $row["link"];?></a></td>
												<td class="cell"><?php echo $row["message"];?></td>
