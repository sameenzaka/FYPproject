...
?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Abdullah Estate</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
			...
			$sql = "SELECT * FROM addhouse where agent_area='$agentarea' and price between $startprice and $endprice";
			...
			$sql = "SELECT * FROM addplot where agent_area='$agentarea' and price between $startprice and $endprice";
			$result = mysqli_query($conn,$sql);
			if(mysqli_num_rows($result)>0){
			while($row=mysqli_fetch_assoc($result)){
			?>					
    			<div class="col-md-4 ftco-animate">
    				<div class="properties">
    					...
    					<div class="text p-3">
    						...
    						<hr>
    						<p class="bottom-area d-flex">
    							<span><i class="flaticon-selection"></i><?php echo ' '.$row['area']; ?> </span>
    							<!-- <span class="ml-auto"><i class="flaticon-bathtub"></i> 3</span>
    							<span><i class="flaticon-bed"></i> 4</span> -->
    						</p>
    					</div>
