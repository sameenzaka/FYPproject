		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<div class="row g-3 mb-4 align-items-center justify-content-between">
					<div class="col-auto">
						<h1 class="app-page-title mb-0">Add New Area</h1>
					</div>
					<div class="col-auto">
				...
				<div class="auth-form-container text-start mx-auto">
					<form class="auth-form auth-signup-form" action="" method="post" enctype="multipart/form-data">
						<div class="email mb-3">
							<label class="sr-only" for="signup-email" >Add New Area</label>
							<input id="area_name" name="area_name" type="text" class="form-control signup-name"
								placeholder="Add New Area" required="required">
						</div>
						<div class="text-center">
							<button type="submit" name="submit" id="submit" class="btn app-btn-primary w-100 theme-btn mx-auto">Add New Area</button>
						</div>
					</form>
					<!--//auth-form-->
