			...
			<div class="sidepanel-inner d-flex flex-column" style="background-color: #f8b425;">
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link active" href="report-display.php">
								<span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-columns-gap"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd"
...
<?php
$sql = "SELECT * FROM invoice i inner join buyer b on i.buyer_id=b.buyer_id";
$result = mysqli_query($conn,$sql);
while($row=mysqli_fetch_assoc($result)){
									...
									<table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Seller Email</th>
												<th class="cell">Seller Phone</th>
												<th class="cell">Date</th>
												<th class="cell">Buyer Name</th>
												<th class="cell">Buyer Address</th>
												<th class="cell">Buyer Phone</th>
												<th class="cell">City</th>
												<th class="cell">Property Type</th>
												<th class="cell">Area</th>
												<th class="cell">Price</th>
												<th class="cell">Agent Commission</th>
												<th class="cell">Buyer Paid</th>
										...
										<?php
										$sql = "SELECT * FROM invoice i inner join seller s on i.seller_id=s.seller_id";
										$result = mysqli_query($conn,$sql);
										if(mysqli_num_rows($result)>0){
										while($row=mysqli_fetch_assoc($result)){
										?>
										<tbody>
											<tr>
												<td class="cell"># <?php echo $row["invoice_id"];?></td>
												<td class="cell"><?php echo $row["seller_name"];?></td>
												<td class="cell"><?php echo $row["seller_email"];?></td>
												<td class="cell"><?php echo $row["seller_phone"];?></td>
												<td class="cell"><?php echo $row["date"];?></td>
												<td class="cell"><?php echo $buyername?></td>
												<td class="cell"><?php echo $row["buyer_address"];?></td>
												<td class="cell"><?php echo $row["buyer_phone"];?></td>
												<td class="cell"><?php echo $row["city"];?></td>
												<td class="cell"><?php echo $row["property_type"];?></td>
												<td class="cell"><?php echo $row["area"];?></td>
												<td class="cell"><?php echo $row["price"];?></td>
												<td class="cell"><?php echo $row["agent_commission"];?></td>
												<td class="cell"><?php echo $row["buyer_paid"];?></td>
												<td class="cell"><?php echo $row["payment_status"];?></td>
												<td class="cell"> <a class="btn btn-primary btn-sm" href="report-print-admin.php?printid=<?php echo $row["invoice_id"];?>&action=print">Print PDF</a></td>
